...
__all__ = [
    ...
    "CAN_OUTRUN_DROID_FACTORY_CONVEYOR",
...
class CharacterAbility(IntFlag):
    ...
    # If a character is too slow, they cannot get past the crusher without jumping around it or using the thin edge of
    # collision along the front edge of the conveyor.
    # run_speed=0.9 is fast enough
    # run_speed=0.8285375 is too slow
    CAN_OUTRUN_DROID_FACTORY_CONVEYOR = auto()
...
CAN_OUTRUN_DROID_FACTORY_CONVEYOR = CharacterAbility.CAN_OUTRUN_DROID_FACTORY_CONVEYOR
...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    ASTROMECH_PANEL: CAN_BARELY_JUMP | CAN_OUTRUN_DROID_FACTORY_CONVEYOR,
    BLASTER: CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    GRAPPLE: BLASTER | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    BOUNTY_HUNTER: BLASTER | GRAPPLE | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    HOVER: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR,
    HIGH_JUMP: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_AGGRAVATE_ENEMIES,
    IMPERIAL: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    JEDI: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE,
    ...
    SITH: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES | IS_NON_GHOST_JEDI,
    JETPACK: BLASTER | GRAPPLE | BOUNTY_HUNTER | HOVER | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    CAN_WEAR_HAT: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR,
    CAN_WEAR_HAT_AND_GRAPPLE: BLASTER | GRAPPLE | CAN_WEAR_HAT | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    ...
    CAN_OUTRUN_DROID_FACTORY_CONVEYOR: CharacterAbility.NONE,
    CAN_JUMP_SLIGHTLY_HIGHER: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE,
    CAN_FLOP_JUMP: BLASTER | GRAPPLE | IMPERIAL | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    CAN_DOUBLE_JUMP: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER,
    CAN_HIGH_JUMP_SLAM: HIGH_JUMP | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES,
    CAN_TRIPLE_JUMP_GREAT_DISTANCE: CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE,
    CAN_ATTACK_UP_CLOSE: CharacterAbility.NONE,
    CAN_DEFLECT_BOLTS: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    ASTROMECH_DROID: ASTROMECH_PANEL | HOVER | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_DISTANCE | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_SELF_DESTRUCT | WEAPON_ZAPPER,
    ...
    WEAPON_EWOK: SHORTIE | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_OUTRUN_DROID_FACTORY_CONVEYOR | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    WEAPON_ZAPPER: CAN_BARELY_JUMP | CAN_OUTRUN_DROID_FACTORY_CONVEYOR,
...
ABILITY_REDUCTIONS: dict[CharacterAbility, CharacterAbility] = {
    ...
    HIGH_JUMP | JEDI | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_DEFLECT_BOLTS: CAN_DOUBLE_JUMP,
    HIGH_JUMP | JEDI | CAN_TRIPLE_JUMP_GREAT_DISTANCE: CAN_DOUBLE_JUMP,
    HIGH_JUMP | JEDI | CAN_DEFLECT_BOLTS: CAN_DOUBLE_JUMP,
