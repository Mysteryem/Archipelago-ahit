...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    IS_NON_GHOST_JEDI: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP | CAN_MELEE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES,
...
COMBINATION_ABILITY_REDUCTIONS: dict[CharacterAbility, CharacterAbility] = {
    ...
    CAN_PULL_LEVERS | CAN_BUILD_BRICKS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_MELEE | CAN_AGGRAVATE_ENEMIES: IS_NON_GHOST_JEDI,
    CAN_PULL_LEVERS | CAN_BUILD_BRICKS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DEFLECT_BOLTS: IS_NON_GHOST_JEDI,
    CAN_PULL_LEVERS | CAN_BUILD_BRICKS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_AGGRAVATE_ENEMIES: IS_NON_GHOST_JEDI,
    ...
    CAN_PULL_LEVERS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_MELEE | CAN_AGGRAVATE_ENEMIES: IS_NON_GHOST_JEDI,
    CAN_PULL_LEVERS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DEFLECT_BOLTS: IS_NON_GHOST_JEDI,
    CAN_PULL_LEVERS | CAN_JUMP_SLIGHTLY_HIGHER | CAN_AGGRAVATE_ENEMIES: IS_NON_GHOST_JEDI,
