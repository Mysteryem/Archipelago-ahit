...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    SITH: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES | IS_NON_GHOST_JEDI,
    ...
    CAN_HIGH_JUMP_SLAM: HIGH_JUMP | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    ...
    IS_NON_GHOST_JEDI: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
