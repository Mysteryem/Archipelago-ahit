...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    CAN_DEFLECT_BOLTS: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
