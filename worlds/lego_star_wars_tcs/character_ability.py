...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    ASTROMECH_PANEL: CAN_BARELY_JUMP,
    BLASTER: CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    GRAPPLE: BLASTER | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    BOUNTY_HUNTER: BLASTER | GRAPPLE | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    HOVER: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_DISTANCE,
    HIGH_JUMP: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_AGGRAVATE_ENEMIES,
    IMPERIAL: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    ...
    SITH: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES | IS_NON_GHOST_JEDI,
    JETPACK: BLASTER | GRAPPLE | BOUNTY_HUNTER | HOVER | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    CAN_WEAR_HAT: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE,
    CAN_WEAR_HAT_AND_GRAPPLE: BLASTER | GRAPPLE | CAN_WEAR_HAT | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    CAN_WEAR_HAT_AND_DOUBLE_JUMP: JEDI | CAN_WEAR_HAT | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE,
    ...
    CAN_FLOP_JUMP: BLASTER | GRAPPLE | IMPERIAL | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    CAN_DOUBLE_JUMP: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER,
    CAN_HIGH_JUMP_SLAM: HIGH_JUMP | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES,
    CAN_TRIPLE_JUMP_GREAT_DISTANCE: CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_ATTACK_UP_CLOSE,
    ...
    ASTROMECH_DROID: ASTROMECH_PANEL | HOVER | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_DISTANCE | CAN_SELF_DESTRUCT | WEAPON_ZAPPER,
    CAN_SELF_DESTRUCT: CharacterAbility.NONE,
    CAN_AGGRAVATE_ENEMIES: CharacterAbility.NONE,
    IS_NON_GHOST_JEDI: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_ATTACK_UP_CLOSE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES,
    WEAPON_EWOK: SHORTIE | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_ATTACK_UP_CLOSE | CAN_AGGRAVATE_ENEMIES,
    WEAPON_ZAPPER: CAN_BARELY_JUMP,
