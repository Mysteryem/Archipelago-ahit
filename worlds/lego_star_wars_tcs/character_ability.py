...
IMPLIED_ABILITIES: dict[CharacterAbility, CharacterAbility] = {
    ...
    BOUNTY_HUNTER: BLASTER | GRAPPLE | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | RUN_SPEED_0_9_OR_HIGHER | CAN_AGGRAVATE_ENEMIES,
    ...
    JEDI: CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP,
    ...
    SITH: JEDI | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | RUN_SPEED_0_9_OR_HIGHER | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES | IS_NON_GHOST_JEDI,
    JETPACK: BLASTER | GRAPPLE | BOUNTY_HUNTER | HOVER | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | RUN_SPEED_0_9_OR_HIGHER | CAN_AGGRAVATE_ENEMIES,
    ...
    CAN_WEAR_HAT_AND_DOUBLE_JUMP: JEDI | CAN_WEAR_HAT | CAN_PULL_LEVERS | CAN_RIDE_VEHICLES_AND_PUSH_OBJECTS | CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | RUN_SPEED_0_9_OR_HIGHER | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP | CAN_TRIPLE_JUMP_GREAT_DISTANCE,
    ...
    CAN_HIGH_JUMP_SLAM: HIGH_JUMP | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | RUN_SPEED_0_9_OR_HIGHER | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP | CAN_DEFLECT_BOLTS | CAN_AGGRAVATE_ENEMIES,
    CAN_TRIPLE_JUMP_GREAT_DISTANCE: CAN_BUILD_BRICKS | CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | RUN_SPEED_0_9_OR_HIGHER | CAN_JUMP_SLIGHTLY_HIGHER | CAN_FLOP_JUMP | CAN_DOUBLE_JUMP,
    CAN_DEFLECT_BOLTS: CAN_BARELY_JUMP | CAN_JUMP_NORMAL_HEIGHT | CAN_JUMP_NORMAL_DISTANCE | CAN_AGGRAVATE_ENEMIES,
