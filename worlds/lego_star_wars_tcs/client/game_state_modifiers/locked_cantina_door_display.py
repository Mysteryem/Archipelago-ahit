...
_CHARACTER_POSITION_VECTOR = NuVecField(0x5c)
"""Feet position of a character (GameObject_s)."""

_HUB_EPISODE_TIME = StaticFloat(0x879594)
...
_ACTIVATION_DISTANCE = 0.30734664296783093
# EPISODE_1_DOOR_ACTIVATION_FURTHEST_ACTIVATION = _Coordinates(-23.21241951, 0.001831591129, -51.91680908)
...
_MAIN_ROOM_DOORS = {
    "1": _Coordinates(-22.9132, 0.0013, -51.9870),
    "2": _Coordinates(-23.2557, 0.0013, -52.9901),
    "3": _Coordinates(-23.7055, 0.0013, -53.9667),
    "4": _Coordinates(-24.3302, 0.0013, -54.8765),
    "5": _Coordinates(-25.2044, 0.0014, -55.5948),
    "6": _Coordinates(-26.2368, 0.0014, -56.1084),
    # "arcade": _Coordinates(-22.4908, 0.0022, -49.889),
    # "bonus": _Coordinates(-28.2893, 0.0015, -57.1381),
    # "junkyard": _Coordinates(-27.9784, 0.1109, -46.8383),
}
_EPISODE_1_DOORS = {
    "1": _Coordinates(-13.7371, 0.0013, -55.6437),
    "2": _Coordinates(-13.5916, 0.0013, -54.0831),
    "3": _Coordinates(-12.8858, 0.0013, -52.9075),
    "4": _Coordinates(-11.6144, 0.0013, -52.2382),
    "5": _Coordinates(-9.9517, 0.0013, -51.9606),
    "6": _Coordinates(-8.4534, 0.0013, -52.4315),
    # "bonus": _Coordinates(-6.4901, 0.0015, -53.8392),
}
_EPISODE_2_DOORS = {
    "1": _Coordinates(-12.2607, 0.0013, -64.5745),
    "2": _Coordinates(-10.8183, 0.0013, -64.5931),
    "3": _Coordinates(-9.4126, 0.0013, -64.3750),
    "4": _Coordinates(-7.9266, 0.0013, -63.7392),
    "5": _Coordinates(-6.7660, 0.0013, -64.6734),
    "6": _Coordinates(-6.6051, 0.0013, -66.0659),
    # "bonus": _Coordinates(-5.7765, 0.0015, -68.8038),
}
_EPISODE_3_DOORS = {
    "1": _Coordinates(-7.4674, 0.0013, -74.3870),
    "2": _Coordinates(-7.4676, 0.0013, -75.5595),
    "3": _Coordinates(-7.3477, 0.0013, -76.6879),
    "4": _Coordinates(-7.1177, 0.0013, -78.0387),
    "5": _Coordinates(-7.2158, 0.0013, -79.3340),
    "6": _Coordinates(-7.8197, 0.0013, -80.4848),
    # "bonus": _Coordinates(-10.0878, 0.0013, -81.1680),
}
_EPISODE_4_DOORS = {
    "1": _Coordinates(-11.9416, 0.0013, -90.8385),
    "2": _Coordinates(-10.8066, 0.0013, -90.8385),
    "3": _Coordinates(-9.6827, 0.0013, -90.9004),
    "4": _Coordinates(-7.1865, 0.0013, -93.2124),
    "5": _Coordinates(-7.1753, 0.0013, -94.3230),
    "6": _Coordinates(-7.1465, 0.0013, -95.4684),
    # "bonus": _Coordinates(-7.0653, 0.0013, -98.1796),
}
_EPISODE_5_DOORS = {
    "1": _Coordinates(-13.3404, 0.0013, -108.3106),
    "2": _Coordinates(-12.3556, 0.0013, -106.8501),
    "3": _Coordinates(-10.7851, 0.0013, -106.1567),
    "4": _Coordinates(-9.4099, 0.0013, -105.9008),
    "5": _Coordinates(-7.8177, 0.0013, -106.4374),
    "6": _Coordinates(-7.0013, 0.0013, -107.5948),
    # "bonus": _Coordinates(-5.7996, 0.0013, -110.5100),
}
_EPISODE_6_DOORS = {
    "1": _Coordinates(-10.2091, 0.0013, -120.9750),
    "2": _Coordinates(-9.2976, 0.0013, -120.0989),
    "3": _Coordinates(-8.1642, 0.0013, -119.6590),
    "4": _Coordinates(-6.9686, 0.0013, -119.8224),
    "5": _Coordinates(-5.9117, 0.0013, -120.4271),
    "6": _Coordinates(-5.1751, 0.0013, -121.4412),
    # "bonus": _Coordinates(-4.1028, 0.0015, -125.8803),
}
# JUNKYARD_DOORS = {
#     "cantina": _Coordinates(-30.6921, 0.04027, -35.0349),
#     "missions": _Coordinates(-33.2018, -0.0048, -29.2741),
# }
# MISSIONS_DOORS = {
#     "junkyard": _Coordinates(-31.8879, 0.1481, -72.2756),
# }

_RELEVANT_ROOMS_TO_DOORS: dict[CantinaRoom, dict[str, _Coordinates]] = {
    CantinaRoom.SHOP_ROOM: _MAIN_ROOM_DOORS,
    CantinaRoom.EPISODE_1: _EPISODE_1_DOORS,
    CantinaRoom.EPISODE_2: _EPISODE_2_DOORS,
    CantinaRoom.EPISODE_3: _EPISODE_3_DOORS,
    CantinaRoom.EPISODE_4: _EPISODE_4_DOORS,
    CantinaRoom.EPISODE_5: _EPISODE_5_DOORS,
    CantinaRoom.EPISODE_6: _EPISODE_6_DOORS,
}
...
class LockedCantinaDoorDisplay(ClientComponent):
    ...
    def on_receive_slot_data(self, event: OnReceiveSlotDataEvent):
        ...
        a_data_list_addr = _A_DATA_LIST_PTR.get(event.context)
        episode_1_ending_area_data_addr = a_data_list_addr + _AREA_DATA_SIZE * _AREA_TO_USE
        _AREA_DATA_NAME_ID.set(event.context, episode_1_ending_area_data_addr, TextId.WII_MOTION_CONTROL_HINT_1)
    ...
    def _draw_info(self, ctx: TCSContext, room_id: CantinaRoom, door_name: str) -> None:
        ...
        if has_drawn:
            ...
            _HUB_AREA.set(ctx, _AREA_TO_USE)
            # Set/refresh the timer.
            _HUB_AREA_TIME.set(ctx, 1.1)
    ...
    async def _draw_locked_door_info(self, event: OnGameWatcherTickEvent):
        ...
        if current_room not in _RELEVANT_ROOMS_TO_DOORS:
            # The player is in a room we don't care about.
            return

        current_doors = _RELEVANT_ROOMS_TO_DOORS[current_room]

        if _HUB_EPISODE_TIME.get(ctx) > 0:
            ...
            if was_drawing:
                ...
                _HUB_AREA_TIME.set(ctx, 0.0)
            return

        if _HUB_AREA.get(ctx) not in (-1, _AREA_TO_USE):
            # Area door text other than our own is currently on-screen.
            return

        # Find if a player is within _ACTIVATION_DISTANCE of a relevant door within this room.
        for _player_number, player_address in player_character_entity_iter(ctx):
            player_pos = _Coordinates(*_CHARACTER_POSITION_VECTOR.get(ctx, player_address))
            for door_name, door_pos in current_doors.items():
                if player_pos.distance(door_pos) < _ACTIVATION_DISTANCE:
