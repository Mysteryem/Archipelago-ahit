...
from .data.items.character_items import NORMAL_CHARACTER_DATA, CharacterData, NON_VEHICLE_CHARACTER_TO_ITEM_DATA
...
from .data.items.vehicle_items import VEHICLE_DATA, ALL_VEHICLE_CHARACTER_TO_ITEM_DATA
