...
from .data.items.character_items import CHARACTER_DATA, CharacterData, CHARACTER_TO_ITEM_DATA
...
from .data.items.vehicle_items import VEHICLE_DATA, VEHICLE_CHARACTER_TO_ITEM_DATA
